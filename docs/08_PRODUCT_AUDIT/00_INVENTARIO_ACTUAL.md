...
>
> **Append F0 (2026-04-25):** este inventario sigue siendo INPUT canónico, complementado ahora por:
> - `docs/08_PRODUCT_AUDIT/11_IE_FILTER_AUDIT_M01_M20.md` (audit retroactivo 5 preguntas IE per feature ✅+🟡)
> - `docs/03_CATALOGOS/03.13_E2E_CONNECTIONS_MAP.md` §"Matriz por Módulo M01-M20" (cascadas E2E 224 filas)
> - `.github/pull_request_template.md` (checklist canónico forward: ADR-018 10 reglas + STUBs 4 señales + 5 preguntas IE)
> Tag `fase-07.7-foundation-locked` pushed. Próximo: F1 Data Reality replacement.
