...
- **L27 DMX Sector Maps como producto B2B** (CB Insights pattern) — visualizaciones segmentadas del mercado licenciables a fondos/asesores institucionales. ARR alto + posicionamiento "CB Insights del real estate LATAM". Bloque sugerido: nuevo BLOQUE 23.SECTOR_MAPS_API como producto licenciable en feature_registry, paquete tier Pro/Enterprise.
