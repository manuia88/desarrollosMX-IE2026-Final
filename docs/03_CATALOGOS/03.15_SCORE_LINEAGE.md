...
- Total scores: **118**
- Scores con dependencies: **44**
- Max upstream depth: **4**
- Scores hoja (sin downstream): **67**
...
| ID | Nombre | Tier | Category | Dependencies |
|---|---|---|---|---|
| F09 | Value Score | 2 | zona | F08, A12 |
| F10 | Gentrification 2.0 | 3 | zona | D05 |
| B03 | Pricing Autopilot | 3 | dev | A12, B08, B07 |
| B05 | Market Cycle | 3 | mercado | B08 |
| B09 | Cash Flow | 3 | dev | B12 |
| B10 | Unit Revenue Opt | 3 | dev | A12 |
| B13 | Amenity ROI | 3 | dev | — |
| B14 | Buyer Persona Proyecto | 3 | dev | H14 |
| B15 | Launch Timing | 3 | dev | B05 |
| C01 | Lead Score | 4 | dev | — |
| C03 | Matching Engine | 4 | comprador | — |
| D03 | Supply Pipeline | 3 | mercado | — |
| H12 | Zona Oportunidad | 3 | comprador | N03, F09, N11 |
| H16 | Neighborhood Evolution | 3 | comprador | N01, F10 |
...
| ID | Nombre | Tier | Category | Dependencies |
|---|---|---|---|---|
| E01 | Full Project Score (interno) | 3 | proyecto | B08, B03, B09, A12, B07, B04 |
| G01 | Full Score 2.0 (público) | 3 | proyecto | E01 |
| E02 | Portfolio Optimizer | 3 | dev | E01 |
| E03 | Predictive Close | 4 | dev | — |
| E04 | Anomaly Detector | 3 | agregado | — |
| D09 | Ecosystem Health | 2 | mercado | N01, N04, N07, F08 |
| D02 | Zona Ranking | 3 | zona | — |
