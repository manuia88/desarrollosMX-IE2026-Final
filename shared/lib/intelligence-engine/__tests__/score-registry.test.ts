...
describe('SCORE_REGISTRY shape', () => {
  it('contiene exactamente 138 entries (137 pre-11.S + Living Atlas 11.S)', () => {
    expect(SCORE_REGISTRY).toHaveLength(138);
  });
...
describe('counts por nivel', () => {
  it('32 N0 + 18 N1 + 15 N2 + 12 N3 + 7 N4 + 54 N5 = 138 (+Living Atlas 11.S)', () => {
    expect(getScoresByLevel(0)).toHaveLength(32);
    ...
    // + 1 Zone Constellations (11.R) + 1 Living Atlas (11.S) + 2 stubs I07/I08 = 54
    expect(getScoresByLevel(5)).toHaveLength(54);
  });
});
