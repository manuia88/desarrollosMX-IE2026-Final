...
import { WidgetScoreCard } from '@/features/widget-embed/components/WidgetScoreCard';
...
export default async function EmbedScorePage({ params, searchParams }: PageProps) {
