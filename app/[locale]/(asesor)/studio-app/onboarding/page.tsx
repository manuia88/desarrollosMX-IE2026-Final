...
// Layout en /studio/layout.tsx ya garantiza auth + studio_users_extension creada.
// Esta page redirige a /studio si onboarding ya está completo, e hidrata el flow client.
...
export default async function StudioOnboardingPage({ params }: StudioOnboardingPageProps) {
  ...
  return (
    ...
    >
      <OnboardingFlow initialStep={initialStep} locale={locale} />
    </main>
  );
}
