-- audit_rls_allowlist v13 — FASE 10 SESIÓN 2/3.
-- Agrega exec_refresh_zone_demographics_cache (SECDEF wrapper para REFRESH MV
-- invocado desde cron /api/cron/zone-demographics-refresh).
...
comment on function public.audit_rls_violations() is
  'v13 — FASE 10 SESIÓN 2/3: allowlist exec_refresh_zone_demographics_cache (L-69 MV refresh cron wrapper).';
