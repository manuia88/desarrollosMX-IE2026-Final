-- audit_rls_violations() v5 — allowlist incluye run_scheduled_deletions (cron job, service_role only)
-- FASE 06 / MÓDULO 6.K (patch)
...
begin
  ...
  return query
  select 'VIEW_NO_SECURITY_INVOKER'::text,
