-- audit_rls_allowlist v14 — FASE 10 SESIÓN 3/3.
-- Agrega:
--   purge_expired_score_history (D34 retention cron wrapper)
--   exec_refresh_heatmap_cache (L-72 MV refresh cron wrapper)
...
comment on function public.audit_rls_violations() is
  'v14 — FASE 10 SESIÓN 3/3: allowlist purge_expired_score_history (D34) + '
  'exec_refresh_heatmap_cache (L-72). Ambas SECDEF invocadas desde crons admin.';
